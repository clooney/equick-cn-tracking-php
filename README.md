# Equick China Tracking API For PHP
Equick China Tracking API and webhook make it easy to integrate Equick China Tracking function into your own project. Support APIs Client Libraries for php

### API key

In order to use this API, you need to generate a Equick China Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Equick China Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Equick China Tracking API](https://www.trackingmore.com/equick-cn-tracking.html)  to:

   *   Get Equick China realtime tracking info of muti-carriers in one integration
   *   Provide Equick China shipment tracking experience like Amazon
   *   Push Equick China notifications of package update with webhook
   *   Verify Equick China delivery exception before it is too late
